...
export const createClientsSection = () => {
  ...
  const clienstTable = document.createElement("table");
  ...
  // цикл который при сортировки меняет стрелки вверх и вниз
  ...
  container.classList.add("container", "clients__conatiner");
  main.classList.add("main");
  clienstTable.classList.add("clients__table");
  createSpan.classList.add("create__span");
  editSpan.classList.add("change__span");
  theadTr.classList.add("display-info__wrapper");
  ...
  // по клику добавляем модальное окно
  ...
  tableWrapper.append(clienstTable, createPreloader());
  clienstTable.append(sortingDisplay, tbody);
