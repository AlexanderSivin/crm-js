...
// функция для окна изменения клиента
export const editClientModal = (data) => {
  ...
  // удаление клиента через модальное окно изменить клиента
  ...
  // закрытие модалки при клике на пустое пространство
  ...
  // получаем в модалку данные о конакте в импуты
  ...
  // удаляет кнопку если больше 10 контактов
