...
export const createClientItem = (data) => {
  // создаем элементы в таблице клиентов
  ...
  // добавляем классы элементам и свойства
  ...
  // создаем иконки типов контактов
  ...
  // при клике на кнопку удалить клиента на главной странице, вызываеться модальное окно
  ...
  // изменение модального окна c "удалить" на "изменить клиента"
